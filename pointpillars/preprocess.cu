...
// dev_pillar_count_histo_ 储存每一个位置上的点云数目
// dev_num_points_per_pillar 根据Max_points_per_pillar过滤后每个位置上的点云数目
// dev_x_coors 每个序号对应点云的x grid坐标
// dev_y_coors 每个序号对应点云的y grid坐标
// dev_pillar_count pillar总数
...
// dev_y_coors 每个序号对应点云的y grid坐标
// dev_num_points_per_pillar 根据Max_points_per_pillar过滤后每个位置上的点云数目
// dev_pillar_point_feature 过滤后的点云按照pillar id排列
...
/*
Input : dev_points, in_num_points
